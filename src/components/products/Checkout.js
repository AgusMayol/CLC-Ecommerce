...
const Checkout = () => {
    ...
    const { totalQuantity, cart, total, clearCart, removeItem, incrementQuantity, decrementQuantity } = useCart()
                    ...
                    confirmado ? (
                        ...
                        totalQuantity > 0 ? (
                            ...
                            <div className="flex justify-center items-center p-4 mt-16">
                                <Link to={"/"}
                                    className="flex items-center h-12 w-full justify-center rounded-md bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm animacion-boton-indigo">
                                    Continuar comprando
                                </Link>
                            </div>
                        )
